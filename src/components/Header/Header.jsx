...
const Header = () => {
  ...
  const filedisp = useSelector(state=> state.newFile)
    ...
    <div>
      ...
      <div className="header__div">
        ...
        <div className="header__title">
          <p><em>React-Drive</em></p>
        </div>

        <div className="header__right" >
          <AddCircleIcon className="add__button" onClick={() => setDisplay(true)}  />
        </div>
      </div>
      </Card>
      ...
      {display ? (
        <div className="disp__modal">
          <Card className="button__div">
          <Button  className="new__file" onClick={()=> dispatch(newFile(),setDisplay(false))}>
          New-File
      </Button>
            <Button color="primary" className="new__folder">New-Folder</Button>
         </Card>
...
//     return{
//         filedisp:state.newFile
//     }
// }

// const mapDispatchToProps=(dispatch)=>{
//     return{
//         newFiledispatch:()=>dispatch(newFile())
